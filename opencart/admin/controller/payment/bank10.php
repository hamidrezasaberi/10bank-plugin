...
class ControllerPaymentbank10 extends Controller {
	...
	public function index() {
		...
		$this->data['entry_bank10_id'] = $this->language->get('entry_bank10_id');
		$this->data['entry_bank10_api'] = $this->language->get('entry_bank10_api');
		...
		if (isset($this->error['bank10_id'])) {
			$this->data['error_bank10_id'] = $this->error['bank10_id'];
		} else {
			$this->data['error_bank10_id'] = '';
		}
		if (isset($this->error['bank10_api'])) {
			$this->data['error_bank10_api'] = $this->error['bank10_api'];
		} else {
			$this->data['error_bank10_api'] = '';
		}
   	...
   	$this->document->breadcrumbs[] = array(
   		...
   		$this->document->breadcrumbs[] = array(
			...
			'href'      => $this->url->link('payment/bank10', 'token=' . $this->session->data['token'], 'SSL'),
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);


			$this->data['action'] = $this->url->link('payment/bank10', 'token=' . $this->session->data['token'], 'SSL');

		  $this->data['cancel'] = $this->url->link('extension/bank10', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['sele1'] = $this->data['sele'] = '';
